...
class SecurityControllerTest extends WebTestCase
{
    ...
    public function setUp()
    {
        ...
        $user = $this->userManager->findUserByUsername("venu@riktamtech.com");
        if ($user) {
    ...
    public function testPostLoginAction()
    {
        ...
        $params = array('_username' => 'venu@riktamtech.com', '_password' => '12345');
        $header = array(
            'HTTP_ACCEPT' => 'application/json',
    ...
    {
        $client = static::createClient();
        $params = array('_username' => 'nonexistent', '_password' => '12345');
        $header = array(
            'HTTP_ACCEPT' => 'application/json',
            'HTTP_Content-Type' => 'application/x-www-form-urlencoded',
        );
